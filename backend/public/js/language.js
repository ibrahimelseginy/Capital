/**
 * SEVEN TECH CAPITAL — Language Manager
 * Bilingual AR/EN with RTL/LTR direction switching
 */

const LangManager = {
  STORAGE_KEY: 'stc-lang',
  currentLang: 'en',

  // Content dictionary for UI strings
  strings: {
    en: {
      // Nav
      nav_home: 'Home',
  ...
  t(key) {
    return (this.strings[this.currentLang] && this.strings[this.currentLang][key]) || key;
  }
};
