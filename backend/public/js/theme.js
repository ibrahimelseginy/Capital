...
const ThemeManager = {
  ...
  getLogoSrc() {
    ...
    const base = window.appBaseUrl ? window.appBaseUrl + '/' : '/';
    return theme === 'dark' 
      ? base + 'Group 102.png'  // White text logo for dark backgrounds
      : base + 'Group 97.png';  // Dark text logo for light backgrounds
  },
  ...
  getIconSrc() {
    ...
    const base = window.appBaseUrl ? window.appBaseUrl + '/' : '/';
    return theme === 'dark'
      ? base + 'Group 99.png'   // White icon
      : base + 'Group 98.png';  // Orange icon
  }
};
