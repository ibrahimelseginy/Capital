...
<div class="fade-in">
    ...
    <div id="documents-tab" class="tab-pane active">
        <div class="files-grid">
            ...
            <a href="{{ $doc->file_path ? Storage::url($doc->file_path) : '#' }}" target="_blank" class="file-card stagger-item" style="text-decoration:none; color:inherit; animation-delay: {{ 0.05 * ($index + 1) }}s;" data-title="{{ strtolower($doc->title) }}">
    ...
    <div id="reports-tab" class="tab-pane">
        <div class="files-grid">
            ...
            <a href="{{ $rep->file_path ? Storage::url($rep->file_path) : '#' }}" target="_blank" class="file-card stagger-item" style="text-decoration:none; color:inherit; animation-delay: {{ 0.05 * ($index + 1) }}s;" data-title="{{ strtolower($rep->title) }}">
                <div class="d-flex justify-between items-start">
