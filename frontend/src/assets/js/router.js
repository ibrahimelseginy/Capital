...
const Router = {
  ...
  navigate() {
    ...
    if (path === '/login') {
      window.location.href = 'http://127.0.0.1:8000/login?lang=' + (localStorage.getItem('stc-lang') || 'en');
      return;
    }

    if (path === '/register') {
      window.location.href = 'http://127.0.0.1:8000/register?lang=' + (localStorage.getItem('stc-lang') || 'en');
      return;
    }
