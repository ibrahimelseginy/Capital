    ...
    <section class="hero" id="hero">
      ...
      <div class="container">
        <div class="hero-content">
          ...
          <h1 class="hero-title reveal reveal-delay-1"><span data-i18n="hero_title_1" style="display: block; margin-bottom: 20px;">We build technology</span><span data-i18n="hero_title_2">companies designed</span> <span class="accent italic-title" data-i18n="hero_title_3">to lead.</span></h1>
